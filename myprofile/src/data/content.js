const content = {
  en: {
    ...
    about: {
      title: "About Me",
      bio: [
        "I'm Undarmaa, a Master's student at Oita University, Japan. I've been living in Japan for 5 years and I'm passionate about cybersecurity — especially Network Security, IoT Security, and Web Security.",
        "I hold a Bachelor's degree in Information Technology from the Mongolian University of Science and Technology, and have 2+ years of real-world experience as a Network Engineer managing IPTV systems.",
        "Currently pursuing my Master's degree while conducting IoT security and Network security research, building security-related projects, and always exploring new vulnerabilities, tools, and techniques in the security space. I communicate in Mongolian, Japanese, and English, and I believe that continuous learning is the key to growth in cybersecurity.",
      ],
      details: {
        name: "Undarmaa",
        university: "Oita University, Japan",
        prevUniversity: "Mongolian University of Science and Technology (MUST)",
        major: "Master's · IoT & Network Security",
      ...
      labels: {
        ...
        prevUniversity: "Previous University",
        major: "Major",
        location: "Location",
  ...
  ja: {
    ...
    about: {
      title: "自己紹介",
      bio: [
        "私はウンダルマーと申します。日本の大分大学の修士課程に在籍しており、日本に住んで5年になります。サイバーセキュリティ、特にネットワークセキュリティ、IoTセキュリティ、Webセキュリティに情熱を持っています。",
        "モンゴル科学技術大学で情報技術の学士号を取得し、IPTVシステムの管理においてネットワークエンジニアとして2年以上の実務経験を積んできました。",
        "現在は修士課程に在籍しながら、IoTセキュリティおよびネットワークセキュリティの研究を行い、セキュリティ関連のプロジェクトを構築しています。セキュリティ分野における新たな脆弱性、ツール、技術を常に探求しています。モンゴル語、日本語、英語でコミュニケーションが取れ、継続的な学習こそがサイバーセキュリティにおける成長の鍵だと信じています。",
      ],
      details: {
        name: "ウンダルマー",
        university: "大分大学",
        prevUniversity: "モンゴル科学技術大学（MUST）",
        major: "修士課程 · IoT・ネットワークセキュリティ",
